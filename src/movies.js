...
function getAllDirectors(moviesArray) {return moviesArray.map(movie => movie.director)}
...
function dramaMoviesScore(moviesArray) {
    ...
    const sum = dramaMovies.reduce((total, movie) => {
        return total + (movie.score || 0)
    },0)
...
function orderByYear(moviesArray) {
    ...
    const sortedMovies = clonedArray.sort((a, b) => {
      if (a.year !== b.year) {
